<?php 
    ...
    if(isset($_POST["nombre"])){
        ...
        $rutaimagen = "../customer/public/images/areas/". $hash;

        move_uploaded_file($tempimagen,$rutaimagen);
        $result = $context->Insert($nombre,$hash,$desc);
...
<?php   
    ...
    <div class="row">
        ...
        <div class="card h-200 border-primary"  style="max-width: 15rem">
            <img class="card-img-top" src="<?php ?>" alt="Card image cap"  width="100" height="100">
                <div class="card-body">                    
