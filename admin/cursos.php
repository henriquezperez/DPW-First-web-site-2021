    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      ...
      <table class="table table-dark table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $result[$i]["cursoid"] ?></td>
                    <td><?php echo $result[$i]["nombre"] ?></td>
                    <td>$<?php echo $result[$i]["costo"] ?></td>
                    <td><?php echo $result[$i]["instructor"] ?></td>
                    <td><?php echo $result[$i]["area"] ?></td>
                    <td><?php echo $result[$i]["Estado"] ?></td>
                    <td>
                        <a class="badge bg-warning" href="cursos-editar.php?id=<?php echo $result[$i]["cursoid"]?>">Editar</a>
                        <a class="badge bg-danger" href="cursos.php?id=<?php echo $result[$i]["cursoid"] ?>">Eliminar</a>                        
                    </td>
                </tr>
                <?php } ?>
            </tbody>
