<?php 
    ...
    if(isset($_GET["identificador"])){
        ...
        $contextDelete = new UsuarioModel();
        $resultDelete = $contextDelete->Delete($id);        
      header("Location:clientes.php?id=2");
    }
?>
...
<?php   
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Usuarios Clientes     Total: <?php echo count($result); ?></h2>
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      ...
      <!--  <a href="curso-nuevo.php" class="btn btn-primary">Nuevo</a> -->
      ...
      <table class="table table-dark table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                       <!-- <a class="badge bg-warning" href="cursos-editar.php?id=<?php echo $result[$i]["ID"]?>">Editar</a> -->
                        <a class="badge bg-danger" href="clientes.php?identificador=<?php echo $result[$i]["ID"] ?>">Eliminar</a>                        
                    </td>
                </tr>
                <?php } ?>
            </tbody>
