...
<?php include("../headers/nav-bar.php") ?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><i class="fas fa-graduation-cap"></i> ¡Estudia una carrera completa!</h1>
    ...
    <h2><i class="fas fa-star"></i>Catálogo</h2>
    <h4><i class="fas fa-list"></i> Áreas disponibles: <?php echo count($result); ?></h4>
        ...
        <div class="row">
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <?php for($i=0; $i<count($result); $i++){?>
                    <div class="col">
                    <div class="card h-100 border-primary" style="max-width: 20rem">
                        ...
                        <div class="card-body">
                            ...
                            <a href="view-cursos.php?id=<?php echo $result[$i]["areaid"]  ?>?name=<?php echo $result[$i]["nombre"] ?>?areaview=<?php echo $result[$i]["areaid"] ?>" class="btn btn-primary" >Ver cursos</a>
                        </div>
                    </div>
                    </div>
                <?php } ?>
